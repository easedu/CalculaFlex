...
import com.example.meunome.calculaflex.extensions.format
...
//        }
        ...
        tvSuggestion.text =  if (priceIndice <= performanceMyCar) getString(R.string.label_ethanol) else getString(R.string.label_gasoline)
